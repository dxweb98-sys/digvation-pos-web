...
export function SaleCompletionDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/35 p-0 backdrop-blur-[2px] sm:items-center sm:p-5">
      <section
        role="dialog"
        aria-modal="true"
        aria-label="Sale Completion"
        className="flex max-h-[96vh] w-full max-w-6xl flex-col overflow-hidden rounded-t-[var(--radius-panel)] border border-[var(--color-border)] bg-[var(--color-surface)] shadow-2xl sm:rounded-[var(--radius-panel)]"
      >
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-2">
                  <label className="text-xs font-semibold text-[var(--color-text-muted)]">
                    ...
                    <select
                      ...
                      className="mt-1.5 w-full rounded-[var(--radius-control)] border border-[var(--color-border)] bg-[var(--color-surface)] px-3 py-2.5 text-sm text-[var(--color-text)]"
                    >
